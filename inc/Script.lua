...
send_key(msg.sender_user_id_,'   [قناة سورس : جوجل](https://t.me/KGTBM)' ,nil,inline,msg.id_)
return false
end
...
return [[
⋆  ━━━  𝒈𝒐𝒐𝒈𝒍𝒆  ━━━ ⋆
{{text="- قناة السورس ،",url="t.me/KGTBM"},
{text="- مبرمج السورس،",url="t.me/KGTBR"}},
{{text="- اضغط هنا لتنصيب السورس ،",url="t.me/KGTBM"}},
{text="- شروحات السورس ،",url="t.me/Kgtbr"}}
]]
end
